...
if ($conn->connect_error) {
    ...
    if ($phonenum != '' && $feedback == '') {
        ...
        $sql = "select phone from user where phone = '$phonenum' and name = '$username'";
        ...
        $newpass_sql = "update user set pass='$newpass' where name='$username'";
        $conn->query($newpass_sql);
        echo '<script>alert("server: Change password successed! Jump to login.");window.location="../login.php";</script>';
    } else {
